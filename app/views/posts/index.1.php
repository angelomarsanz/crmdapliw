...
function guardarPersona(indicadorCheckbox)
{
    ...
    primerNombre = $j("#primerNombre110").val($j.trim($j("#primerNombre110").val().toUpperCase()));

    if ($j("#segundoNombre110").val().length > 0)
    {
        segundoNombre = $j("#segundoNombre110").val($j.trim($j("#segundoNombre110").val().toUpperCase())); 
    }    
    else
    {
        segundoNombre = "";
    ...
    primerApellido = $j("#primerApellido110").val($j.trim($j("#primerApellido110").val().toUpperCase()));

    if ($j("#segundoApellido110").val().length > 0)
    {
        segundoApellido = $j("#segundoApellido110").val($j.trim($j("#segundoApellido110").val().toUpperCase())); 
    }    
    else
    {
        segundoApellido = "";
    ...
    {
        celular = $j("#celular110").val($j.trim($j("#celular110").val().toUpperCase())); 
    }    
    else
    {
        celular = "";
    ...
    {
        telefonoFijo = $j("#telefonoFijo110").val($j.trim($j("#telefonoFijo110").val().toUpperCase())); 
    }    
    else
    {
        telefonoFijo = "";
    ...
    {
        direccion = $j("#direccion110").val($j.trim($j("#direccion110").val().toUpperCase())); 
    }    
    else
    {
        direccion = "";
        ...
        'persona' :  
            {
                ...
                "email" : $j("#email110").val($j.trim($j("#email110").val().toUpperCase())),
                "direccion" : direccion
            }
        };
